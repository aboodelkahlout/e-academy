...
class CourseRequest extends FormRequest
{
    ...
    public function messages() : array
    {
        ...
        'specialization.required' => 'Please specify the course specialization.',
        'specialization.min' => 'The specialization must be at least 3 characters.',
        'specialization.max' => 'The specialization may not be greater than 100 characters.',
